      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="mt-3 text-gray-600">
            Choose the right service plan for your bike.
          </p>
        </div>
        ...
        <div className="grid gap-8 grid-cols-1 md:grid-cols-2">
          {services.map((service, index) => (
            <motion.div
              ...
              className={`rounded-2xl p-8 shadow-md hover:shadow-lg bg-white border ${
                service.highlight
              ...
              <ul className="mt-6 space-y-3 text-gray-700">
                {service.features.map((feature, i) => (
                  <li key={i} className="flex gap-3">
                    <span className="w-6 h-6 rounded-full bg-yellow-50 text-yellow-700 flex items-center justify-center text-xs font-bold">
                      ✓
                    </span>
                    {feature}
                  </li>
